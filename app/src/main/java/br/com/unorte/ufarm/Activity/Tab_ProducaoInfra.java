...
public class Tab_ProducaoInfra extends FragmentActivity {
    ...
    EditText edtQtde;
    Spinner spiUnMedida;
    RadioButton rbFuncionario;
    RadioButton rbTerceirizado;
    EditText edtVlUn;
    EditText edtVlTotal;
    Spinner spiStatus;
    Button btnGravar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_producao_infra);
        ...
        rbFuncionario = (RadioButton) findViewById(R.id.rbFuncionario);
        rbTerceirizado = (RadioButton) findViewById(R.id.rbTerceirizado);
