...
public class FragSeguro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_frag_seguro, container, false);
      ...
      //REcuperação do spinner
		...
		ListaCategoria = FormulariosDao.buscaUfarmFormulariosLegenda("C74","","","","");
