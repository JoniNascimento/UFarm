...
public class FragInsumos extends Fragment {	
	...
	public void onCreate(Bundle savedInstanceState) {
	 ...
	 @Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	        ...
	        View v = inflater.inflate(R.layout.activity_frag_insumos, container, false);
	      ...
	      //REcuperação do spinner
			...
			ListaCategoria = FormulariosDao.buscaUfarmFormulariosLegenda("C14","","","","");
	        ...
	        //CustomArrayAdapter<String> arrayAdapter = new CustomArrayAdapter<String>(getContext(), operacao);
			ArrayAdapter<UfarmFormularios> spinnerArrayAdapterArrayAdapterCategoria = ArrayAdapterCategoria;
			spinnerArrayAdapterArrayAdapterCategoria.setDropDownViewResource(R.layout.texto_personalizado);
			spiCategoria.setAdapter(spinnerArrayAdapterArrayAdapterCategoria);
			
			
			ListaSubCategoria = FormulariosDao.buscaUfarmFormulariosLegenda("C15","C38","C39","","");
	...
	public void GravaInsumos(){
		...
		ObjAquisicoes.setProdServico("Insumos");
		...
		ObjAquisicoes.setSubCategoria(spiSubCategoria.getSelectedItem().toString());
